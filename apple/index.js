const apple1 = document.querySelector('.apple_123')
const openModal = document.querySelector('[data-modal]')
const closeModal = apple1.querySelector('[data-close]')
...
closeModal.onclick = () => {
    apple1.classList.add('fade_inversion')
    setTimeout(() => {
        apple1.close()
        apple1.classList.remove('fade_inversion')
    }, 500)
}

const colors_btn = document.querySelectorAll('button')
const img = document.querySelector('.iphones')
const iphones = {
